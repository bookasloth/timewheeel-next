...
import { aimStats } from "@/lib/ai-marketing";

const statColors = ["#8b5cf6", "#269cef", "#4ab765"];

// Dark "in numbers" band, gradient counts with a subtle ring decoration.
export function AimTrust() {
  return (
    <section className="relative overflow-hidden border-y border-white/10 bg-navy text-white">
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(60% 80% at 12% 0%, rgba(139,92,246,0.16), transparent 60%), radial-gradient(50% 70% at 88% 100%, rgba(38,156,239,0.12), transparent 60%)",
        }}
      />
      <svg
        aria-hidden
