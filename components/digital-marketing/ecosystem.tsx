...
// Circle geometry (660x660 canvas, center 330,330).
const CANVAS = 660;
const CENTER = 330;
...
export function DmEcosystem() {
  ...
  return (
    <section className="mx-auto max-w-6xl px-6 pb-2 pt-20 md:pb-8 md:pt-28">
      ...
      {/* Mobile / small screens: clean vertical flow, no connector lines */}
      ...
      {/* Desktop / tablet: circular orbit around the TIMEWHEEL hub */}
      <Reveal stagger className="relative mx-auto mt-4 hidden md:block">
        <div className="relative mx-auto h-[660px] w-[660px]">
          ...
          {/* channel + outcome nodes on the orbit */}
          {ORBIT.map(({ name, dx, dy }) => {
            const lit = active === name;
            return (
              <div
