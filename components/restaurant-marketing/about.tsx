...
const facts = [
  ...
  {
    number: "02",
    title: "Grey Hawks Media Pvt. Ltd.",
    body: "An advertising agency based in Mumbai, helping restaurants turn first-time visitors into loyal customers.",
  },
  {
    number: "03",
    title: "The go-to dining destination",
    body: "Let's grow your brand and make it the go-to dining destination in your city.",
  },
];

export function RmAbout() {
  return (
